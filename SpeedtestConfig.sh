...
viewsharevar='"/tmp"'
grep -qxF "view.sharingFolders = $viewsharevar" /tmp/config/files/vmware/view-preferenes || echo "view.shareFolders = $viewsharevar" >> /tmp/config/files/vmware/configaddon
